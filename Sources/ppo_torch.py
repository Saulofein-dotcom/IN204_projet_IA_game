...
class Agent:
    def __init__(self, n_actions, input_dims, gamma=0.99, alpha=0.0003, gae_lambda=0.95,
                policy_clip=0.2, batch_size=64, N=2048, n_epochs=10, make_env_fn=None, make_env_kargs=[]):
        self.gamma = gamma
    ...
    def demo_last(self, title='Fully-trained {} Agent', n_episodes=2, max_n_videos=2):
        ...
        self.actor.load_state_dict(T.load('./tmp/ppo/actor_torch_ppo'))

        self.evaluate(self.actor, env, n_episodes=n_episodes)
        env.close()
